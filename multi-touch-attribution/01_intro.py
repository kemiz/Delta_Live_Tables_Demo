...
# MAGIC   * **data_gen_path:** data generated in this notebook will be written to this file path. This file path is derived from **project directory**
